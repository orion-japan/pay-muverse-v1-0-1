       ...
       // =========================================================
        ...
        try {
          ...
          const practicalSafeText = String(outText ?? '')
            .replace(/このくらいで十分です。?/g, '今見るのは、返事が欲しいのか、安心を確かめたいのかです。')
            .replace(/これくらいで十分です。?/g, '今見るのは、返事が欲しいのか、安心を確かめたいのかです。')
            .replace(/くらいで十分です。?/g, 'くらいに整えると、気持ちが重く出すぎにくいです。')
            .replace(/それで十分です。?/g, '今見るのは、返事が欲しいのか、安心を確かめたいのかです。')
            .replace(/十分です。?/g, '今見るのは、返事が欲しいのか、安心を確かめたいのかです。')
            .replace(/これで足ります。?/g, '今見るのは、返事が欲しいのか、安心を確かめたいのかです。')
            .replace(/それで足ります。?/g, '今見るのは、返事が欲しいのか、安心を確かめたいのかです。')
            .replace(/で足ります。?/g, 'で整える形が合います。')
