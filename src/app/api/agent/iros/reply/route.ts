              ...
              messages: [
                {
                  ...
                  content: [
                    ...
                    '保存したことを説明しない。ラベル確認を返さない。対象ラベルを本文に出さない。RC_STABILIZE_SEED から、本人側の揺れ・関係の温度・次に見る基準を返す。',
                ...
                },
                {
                  ...
                  content: [
                    ...
                    '',
                    'RC_STABILIZE_SEED をもとに、Muの自然な本文にしてください。',
                    '禁止：片思いと断定する、相手の本心を決めつける、保存確認だけで終わる、ラベル説明だけで終わる。',
                    '推奨：「見えているのは、相手の気持ちそのものより、分からないまま近づく怖さです。だから今は、答えを急いで確かめるより、軽く話しかけられる距離を作る方が合っています。返しやすい短い言葉を一つ置いて、返ってくる温度を見てください。」のように、対象ラベルで始めず、方向と次の見方を返す。',
                    'RC_STABILIZE_SEED:',
                    ...
                    'forbidden_phrases: との関係として / 気になっている相手との関係として / 受け取ります / 見ていきます / 文脈で / として扱います / 相手の気持ちは、いま決めつけない方がいいです / 静かに / 距離を作れるか / 確かめるのが合っています',
