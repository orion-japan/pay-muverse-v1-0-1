...
async function writeDiagnosisFromSeed(params: {
  ...
  const writerSystem = [
    ...
    'WRITER_IMAGINAL_COPY_FUTURE_LABEL_RULES_V1',
    'イマジナルコピーは、少しゆかいで記憶に残るコピーにしてください。',
    'ただし、ユーザーをからかわないでください。ふっと力が抜けるが、本文でまじめに回収できるコピーにしてください。',
    'イマジナルコピーは必ず「未来」で終えてください。',
    '基本形は「〇〇する〇〇の未来」「〇〇が〇〇する〇〇の未来」「〇〇している〇〇の未来」です。',
    '末尾の分類は、まず「不安の未来」「比較の未来」「破壊の未来」を検討してください。',
    '不安・比較・破壊のどれにも入らない場合は、無理に創造の未来へ入れないでください。',
    '不安・比較・破壊に入らない場合は、その画像に合う自然な分類名を新しく作ってよいです。例: 受け取りの未来、役割拡張の未来、境界線の未来、選択の未来、手放しの未来、創造の未来、確認の未来。',
    'ただし、分類名は長くしすぎないでください。末尾は必ず「〇〇の未来」にしてください。',
    'confirmation_future の場合は、原則として「不安の未来」に寄せてください。ただし、境界線や手放しが明確な場合は新しい分類名にしてよいです。',
    'receiving_future の場合は、「創造の未来」に固定せず、「受け取りの未来」を優先してください。',
    'expanded_role_future の場合は、「創造の未来」に固定せず、「役割拡張の未来」を優先してください。',
    'release_future の場合は、「手放しの未来」を優先してください。',
    'choice_future の場合は、「選択の未来」を優先してください。',
    'copy_material が重い場合でも、コピー自体は少しゆかいにしてください。例: 既読の前で正座する不安の未来、ありがとうを小さく畳む受け取りの未来、役割の風船をそっと持つ役割拡張の未来。',
  ...
  const writerUser = [
    ...
    'WRITER_USER_IMAGINAL_COPY_FUTURE_LABEL_RULES_V1',
    'イマジナルコピーは必ず〇〇の未来で終えてください。',
    'コピー末尾は、まず「不安の未来」「比較の未来」「破壊の未来」を検討してください。',
    'その3つに入らない場合は、無理に創造へ寄せず、その画像に合う自然な「〇〇の未来」を新しく作ってください。',
