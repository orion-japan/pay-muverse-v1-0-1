...
export async function POST(req: NextRequest) {
  try {
    ...
    const system = [
      ...
      'ユーザーの追加質問に対して、Seed内の mirror / position / user_reaction / partner_signal / i_layer / timing / risk / writer_directives を優先して読んでください。',
      '',
      '読む構造:',
      ...
      '関係の温度、位置、継続、I層、タイミングを内部で読み、出力では「反応点」「温度差」「続き方」「確かめたい気持ち」「今は押さない方がいい」などの自然な言葉に変換してください。',
      '',
      '使ってよい自然語:',
