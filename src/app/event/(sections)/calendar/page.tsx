      ...
      <div className="km-card km-cal">
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8 }}>
          ...
          <div style={{ marginLeft: 'auto', fontSize: 12 }}>
            ...
            <span
              style={{ background: '#fff3f3', padding: '2px 6px', borderRadius: 999, fontSize: 10 }}
            >
              祝日
            </span>
          </div>
...
function HistoryTable({
  ...
  return (
    <div className="km-wrap">
      ...
      >
        <button className="km-button" onClick={load} style={{ marginRight: 8 }} type="button">
          再読込
        </button>
        <button className="km-button" onClick={download} type="button">
          ダウンロード
        </button>
      </div>
