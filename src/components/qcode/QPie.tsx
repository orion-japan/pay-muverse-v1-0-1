...
export default function QPie({
  ...
  appearance='none',
  polarityCounts
}: { counts: Counts; appearance?: QPieAppearance; polarityCounts?: PolarityCounts }) {
  ...
  if (appearance === 'ring') {
    ...
    return (
      <div style={{ position:'relative', width:size, height:size }}>
        ...
        >
          <div style={{ fontSize:20, fontWeight:700, color:'#334', lineHeight:1 }}> {totalRaw} </div>
