...
const makeLink = (
  type: 'x' | 'instagram' | 'facebook' | 'linkedin' | 'youtube' | 'web',
  raw?: string,
) => {
  ...
  if (/^https?:\/\//i.test(v))
    return (
      <a href={v} target="_blank" rel="noopener noreferrer" className="mu-link">
        {v}
      </a>
    );
        ...
        : type === 'facebook'
          ...
          : type === 'linkedin'
            ...
            : type === 'youtube'
              ...
              : `https://${handle}`;
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="mu-link">
      {url}
    </a>
  );
};
