  ...
  return (
    <>
      ...
      <div className="rx-head">
        ...
        <button className="mu-ghost-btn" onClick={() => load()} aria-label="再読み込み">
          再読み込み
        </button>
      </div>
        ...
        <div className="rx-grid">
          ...
          <div className="rx-card">
            ...
            <ul className="rx-list">
              <li>
                ...
                <span className="rx-label">いいね</span>
                <span className="rx-val">{received.like}</span>
              </li>
              <li>
                <span className="rx-emoji">❤️</span>
                <span className="rx-label">ハート</span>
                <span className="rx-val">{received.heart}</span>
              </li>
              <li>
                <span className="rx-emoji">😊</span>
                <span className="rx-label">スマイル</span>
                <span className="rx-val">{received.smile}</span>
              </li>
              <li>
                <span className="rx-emoji">😮</span>
                <span className="rx-label">ワオ</span>
                <span className="rx-val">{received.wow}</span>
              </li>
              <li>
                <span className="rx-emoji">🔁</span>
                <span className="rx-label">共鳴</span>
                <span className="rx-val">{received.share}</span>
              </li>
            </ul>
          </div>
          ...
          <div className="rx-card">
            ...
            <ul className="rx-list">
              <li>
                <span className="rx-emoji">👍</span>
                <span className="rx-label">Like</span>
                <span className="rx-val">{given.like}</span>
              </li>
              <li>
                <span className="rx-emoji">❤️</span>
                <span className="rx-label">Heart</span>
                <span className="rx-val">{given.heart}</span>
              </li>
              <li>
                <span className="rx-emoji">😊</span>
                <span className="rx-label">Smile</span>
                <span className="rx-val">{given.smile}</span>
              </li>
              <li>
                <span className="rx-emoji">😮</span>
                <span className="rx-label">Wow</span>
                <span className="rx-val">{given.wow}</span>
              </li>
              <li>
                <span className="rx-emoji">🔁</span>
                <span className="rx-label">Resonance</span>
                <span className="rx-val">{given.share}</span>
              </li>
            </ul>
          </div>
        </div>
