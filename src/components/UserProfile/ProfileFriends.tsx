    ...
    (async () => {
      try {
        ...
        const res = await fetch(
          `/api/shipmates?owner=${encodeURIComponent(profile.user_code)}`,
    ...
    <div>
      ...
      <style jsx>{`
        ...
        .summary-card {
          ...
          padding: 10px 12px;
          text-align:center;
          box-shadow: 0 8px 22px rgba(90,120,255,.08);
        ...
        .shipmate-left { display:flex; align-items:center; }
        ...
        .shipmate-center { display:grid; gap:2px; }
        .shipmate-name { font-weight:600; line-height:1.2; }
