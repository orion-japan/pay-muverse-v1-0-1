          ...
          footer={
            <div className="actions">
              <button
                ...
                disabled={busy}
                onClick={async () => {
                  await persist('stage4-1', PROMPTS_STAGE4.step1.nextStep);
                }}
              >
                この内容を記録
              </button>
          ...
          footer={
            <div className="actions">
              <button
                ...
                disabled={busy}
                onClick={async () => {
                  await persist('stage4-2', PROMPTS_STAGE4.step2.nextStep);
                }}
              >
                この内容を記録
              </button>
          ...
          footer={
            <div className="actions">
              <button
                ...
                disabled={busy}
                onClick={async () => {
                  await persist('stage4-3', PROMPTS_STAGE4.step3.nextStep);
                }}
              >
                この内容を記録
              </button>
