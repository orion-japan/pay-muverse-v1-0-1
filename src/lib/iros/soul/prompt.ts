...
// Iros Soul Engine — ユーザーの「奥の願い」と「今日の一歩の種」を抽出する層
//
...
ユーザーの発言とメタ情報から、
「その人の奥にある願い」と「今日の一歩の“種”」を抽出することだけに集中してください。
...
- 「やらなければダメ」「もっと頑張れ」ではなく、
  静かな安心や小さな歓喜に向かう一歩として step_phrase / micro_steps を設計する。
...
- 特に抑うつ・虚無が強い帯域では、
  ...
  - 行動を煽るのではなく「責めないでいられること」自体を一歩として扱ってください。
