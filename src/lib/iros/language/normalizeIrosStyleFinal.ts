...
const DICT_20: DictEntry[] = [
  // 操作動詞系
  { from: '真ん中に示す', to: 'まず大事にしよう' },
  // NOTE: 「示す」は iros の中核語なので、単体置換はしない（過剰変換になる）
  // { from: '示す', to: '言葉にする' },
  { from: '固定する', to: 'いったん決めてみよう' },
  { from: '圧縮する', to: 'まとめる' },
  { from: '焦点を当てる', to: 'ここを見てみよう' },
  // STYLE_DICT_RELATION_WORD_GUARD
  // 関係相談で「あて／当て」「勝つ」が操作感・勝敗感に見えるため、句単位で自然語へ寄せる
  { from: '気持ちを当てにいく', to: '気持ちを読みにいく' },
  { from: '気持ちを当てに行く', to: '気持ちを読みにいく' },
  { from: '当てにいく', to: '読みにいく' },
  { from: '当てに行く', to: '読みにいく' },
  { from: '言い当てる', to: '見抜く' },
  { from: '言い当て', to: '見抜き' },
  { from: '勝とうとする', to: '優位に立とうとする' },
  { from: '勝ちにいく', to: '優位に立とうとする' },
  { from: '勝ちに行く', to: '優位に立とうとする' },
  { from: '勝つこと', to: '優位に立つこと' },
  { from: '一語で', to: '一言でいうなら' },
  ...
  // Mu会話で硬く見える「置く」系の最終保険
  { from: '感情は置く', to: '感情をそのままぶつけない' },
  { from: '怒りは置く', to: '怒りをそのままぶつけない' },
  { from: '短く置く', to: '短く伝える' },
  { from: '一通置く', to: '一通だけ送る' },
  { from: '軽く一通置く', to: '軽く一通だけ送る' },
  { from: '事実を置く', to: '事実だけを伝える' },
  { from: '事実だけを置く', to: '事実だけを伝える' },
  { from: '言葉で置く', to: '言葉にする' },
  { from: 'そのまま置く', to: 'そのまま言葉にする' },
  { from: 'だけ置く', to: 'だけ書く' },
