...
export const MIRRA_PRICE_IN  = Number(process.env.MIRRA_PRICE_IN  ?? 2.50) / 1_000_000;
export const MIRRA_PRICE_OUT = Number(process.env.MIRRA_PRICE_OUT ?? 10.00) / 1_000_000;
