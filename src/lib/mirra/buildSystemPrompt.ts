...
export function buildSystemPrompt(opts: MirraPromptOpts = {}) {
  ...
  // ===== 継続相談用（自由に深掘るが構成・余白・具体性・リメイク方針を保持）=====
  return [
    ...
    '各返答には必ず「身体アンカー」か「20〜60秒の小さな実験」を1つ入れる（例: みぞおちに手を当てて2呼吸／机の角を指でなぞる／20秒だけ箇条書き 等）。',
